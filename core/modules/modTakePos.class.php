...
/**
 *  Description and activation class for module TakePos
 */
class modTakePos extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 571042;		// TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->description = "Touch Screen POS";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Touch Screen POS";

		$this->editor_name = 'Take POS';
