...
/**
 * \file    modulebuilder/template/core/boxes/takeposwidget1.php
 * \ingroup takepos
 * \brief   Widget provided by TakePos
 *
 ...
 */
class takeposwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "takeposbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "takepos@takepos";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->takepos->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/takepos/class/takepos.class.php";

		// Populate the head at runtime
		$text = $langs->trans("TakePosBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_takepos@takepos',
